...
The model is trained via cross-entropy loss applied to each timestep using discrete WavLM audio
representations (see https://arxiv.org/abs/2110.13900, https://arxiv.org/abs/2309.07377).
...
To run this recipe:
> python train_discrete_wavlm.py hparams/train_discrete_wavlm.yaml
