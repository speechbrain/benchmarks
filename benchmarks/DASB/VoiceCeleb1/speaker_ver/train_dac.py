...
def compute_embedding(wavs, wav_lens):
    ...
    with torch.no_grad():
        ...
        tokens,_ = speaker_brain.hparams.codec(
                wavs.unsqueeze(1), n_quantizers=speaker_brain.hparams.num_codebooks
            )
        embeddings = speaker_brain.modules.discrete_embedding_layer(tokens.movedim(-2, -1))
